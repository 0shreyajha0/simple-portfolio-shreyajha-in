...
const BlogsConfig = [
    {
        metadata: {
            title: "GitHub + Copilot + PMs = A Day Full of “Aha!” Moments",
            publishedAt: "Jun 5, 2025",
        },
        url: "https://medium.com/@0shreyajha0/github-copilot-pms-ai-a-day-full-of-aha-moments-1763f4b6e3cd",
        image:
            "https://miro.medium.com/v2/resize:fit:1400/0*9r_GPIweYWqv6M5i",
        content: "Yesterday, I attended an event hosted by the GitHub team at the Microsoft Office in Noida - and no exaggeration, it felt like revisiting…",
    },
    {
        metadata: {
            title: "Using Mind Science to Build Products🧠",
            publishedAt: "Apr 27, 2025",
        },
        url: "https://medium.com/@0shreyajha0/why-product-thinking-needs-more-psychology-and-less-hacking-a50956752064",
        image:
            "https://miro.medium.com/v2/resize:fit:1400/0*ccZsWHXeKToxbM_z",
        content: "Users don’t drop off because your button is blue instead of green. They drop off because something didn’t make sense — or didn’t feel…",
    },
    {
        metadata: {
            title: "From Guesswork to Growth: A/B Testing Basics Every PM Needs",
            publishedAt: "Apr 20, 2025",
        },
        url: "https://medium.com/@0shreyajha0/from-guesswork-to-growth-a-b-testing-basics-every-pm-needs-4b864205fdbc",
        image:
            "https://miro.medium.com/v2/resize:fit:1400/0*J6GIryI_VdvSEQ2o.png",
        content: "As a product manager, understanding A/B testing is essential, not only does it empower you to make data-driven decisions, but it also…",
    },
    {
        metadata: {
            title: "User Interviews: A Product Manager’s Secret Weapon",
            publishedAt: "Feb 23, 2025",
        },
        url: "https://medium.com/@0shreyajha0/the-art-of-user-interviews-a-pms-secret-weapon-0f484d1ba610",
        image:
            "https://miro.medium.com/v2/resize:fit:1400/1*YN7Mvo1O_FPD-D3lOUoiNA.png",
        content: "Many people, many times, ask me, “What’s your way of doing user interviews?” or I’ve seen so many product managers run user interviews…",
    },
    {
        metadata: {
            title: "What is PRD??",
                ...
                {allBlogs.map((post) => (
                    ...
                    >
                        <div
                            ...
                            <div className="w-96">
                                <h2 className="text-black font-semibold dark:text-white group-hover:text-blue-900 dark:group-hover:text-neutral-400">
                                    {post.metadata.title}
                                </h2>
                                <p className="text-neutral-600 dark:text-neutral-400 tabular-nums text-sm group-hover:text-blue-900 dark:group-hover:text-neutral-400">
                                    {post.content}
                                </p>
                                <p className="text-neutral-600 mt-3 mb-2 dark:text-neutral-400 tabular-nums text-sm group-hover:text-blue-900 dark:group-hover:text-neutral-400">
